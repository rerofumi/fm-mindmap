...
const NormalNode = ({ id, data, selected }: NodeProps<MindMapNodeData>) => {
  ...
  return (
    <Card
      ...
      className={cn(
        'border-2 w-40 rounded-md text-white',
      ...
      <CardContent className="p-2">
        {isEditing ? (
          <textarea
            ...
            className="w-full bg-transparent text-white text-center font-semibold p-0 m-0 border-none outline-none resize-none"
            style={{
              fontFamily: 'inherit',
              fontSize: 'inherit',
              lineHeight: 'inherit',
